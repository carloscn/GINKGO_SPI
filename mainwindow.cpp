    ...
    ui(new Ui::MainWindow)
{
    ...
    pixmap.load(":/images/images/welcome_4.png");
    ...
    screen.showMessage("Init GUI logic...",Qt::AlignRight | Qt::AlignBaseline,Qt::black);
    QThread::sleep(0.5);
    ui->setupUi(this);
    ...
    screen.showMessage("Init status...",Qt::AlignRight | Qt::AlignBaseline,Qt::black);
    QThread::sleep(2);
    ...
    screen.showMessage("Init GINKGO...",Qt::AlignRight | Qt::AlignBaseline,Qt::black);
    QThread::sleep(1);

    screen.showMessage("Load GUI....",Qt::AlignRight | Qt::AlignBaseline,Qt::black);
    QThread::sleep(0.9);
    screen.close();
